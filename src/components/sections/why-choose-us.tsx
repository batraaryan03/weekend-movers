    ...
    <section className="py-16 bg-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#011936] mb-4">Why Choose Weekend Movers</h2>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">Melbourne&apos;s trusted local movers with a commitment to excellence</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {features.map((f) => (
            <div key={f.title} className="flex items-start gap-4">
              <div className="shrink-0">
                <div className="bg-[#FFB624] w-12 h-12 flex items-center justify-center">
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-xl font-bold text-[#011936]">{f.title}</h3>
                </div>
