    ...
    <footer className="bg-[#011936] text-white">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              {[
                ...
                { label: "Book Move", href: "/book-move" },
              ].map((link) => (
                <a
                  key={link.label}
                  href={link.href}
          ...
          <div>
            ...
            <div className="flex gap-3 mb-8">
              <a
                ...
                className="bg-white/10 hover:bg-[#FFB624] w-10 h-10 flex items-center justify-center transition-all duration-200 hover:scale-110"
              >
            ...
            <a
              href="/book-move"
              className="block bg-[#FFB624] text-[#011936] font-bold text-sm py-3 px-6 text-center hover:bg-yellow-500 transition-colors"
            >
      ...
      <div className="border-t border-white/10 py-6">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between text-sm text-white/50">
          <p>&copy; {new Date().getFullYear()} Weekend Movers. All rights reserved.</p>
